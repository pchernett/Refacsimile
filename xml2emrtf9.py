...
# filename = args[0]
parts = filename.split('.',1)	#Splits filename into 2 parts
stem=parts[0]
outfile = stem+".rtf"
...
tune = tunedata()	# Create one instance of the tune object

font_object = fontdata_class() # And one istance of fontdata
